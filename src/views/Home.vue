        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde sus inicios, la microeconomía ha sido una herramienta fundamental para comprender cómo los agentes económicos —individuos, empresas y gobiernos— toman decisiones en la asignación de recursos limitados. Esta unidad proporciona los conceptos claves que permiten analizar las interacciones en los mercados, entender el comportamiento del consumidor, del productor y los factores que influyen en la oferta y demanda de bienes y servicios. Al dominar estos principios, será posible interpretar fenómenos económicos, evaluar políticas públicas y optimizar la toma de decisiones en contextos personales y profesionales.
              
              p #[b ¡Prepárate para analizar el entorno económico con precisión y tomar decisiones estratégicas!]
